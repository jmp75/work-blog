...
This post is a follow up on [Using nbdev on Windows](https://jmp75.github.io/work-blog/posts/20221007-nbdev-windows/), which explains the motivation for assessing now nbdev works on Windows, natively (i.e. not from a unix emulation or WSL).
