...
It is probably time to set up a dedicated git repository. [sf-installer](https://github.com/csiro-hydroinformatics/sf-installer)

At this point, repo [at commit fda17e609e784791935b45f96e0c79a6dd2cc307](https://github.com/csiro-hydroinformatics/sf-installer/tree/fda17e609e784791935b45f96e0c79a6dd2cc307)
...
At this point, repo [at commit 4d8d1d7c8b50221c7f63af3aa96115c438cb5055](https://github.com/csiro-hydroinformatics/sf-installer/tree/4d8d1d7c8b50221c7f63af3aa96115c438cb5055)
...
At this point, repo [at commit 012521407cc63e1233ff40a784d17b5f43dc6caf](https://github.com/csiro-hydroinformatics/sf-installer/tree/012521407cc63e1233ff40a784d17b5f43dc6caf)
...
I think this is exactly what Rob demonstrated, and I expected this. This is less intuitive to deduce what would happen if we install version `0.1.1.0` on top of `0.1`. And the result is:
